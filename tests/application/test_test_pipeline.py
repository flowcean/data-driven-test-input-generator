...
import os
import polars as pl
from ddtig import TestPipeline
...
class TestTestPipeline(unittest.TestCase):
    ...
    def setUp(self):
        ...
        model_file = os.path.join(dirpath, "resources/BodyFat.fml")        
        dataset = pl.read_csv(os.path.join(dirpath, "resources/BodyFat.csv"))
    ...
    def test_equivalence_classes(self):
        ...
        self.assertTrue((len(self.test_pipeline_bva_inverse.eqclasses) == 
                         ...
                         len(self.test_pipeline_dtc_prop.eqclasses) == 103), "Number of classes is not correct")
